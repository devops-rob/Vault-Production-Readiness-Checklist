...
| &#9744;   | <details><summary>Replication (Enterprise only)</summary> <p> If you are using the Enterprise version of Vault, you can enable replication between two or more Vault clusters in different geographical regions for added protection is Disaster Recovery scenarios.  Replication can be configured in Disaster Recovery Mode or Performance Replication mode.  For more information about this Enterprise feature, see [the official documentation](https://www.vaultproject.io/docs/internals/replication/) </p> </details> |
